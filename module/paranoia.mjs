...
Hooks.once('init', function () {
  ...
  CONFIG.Actor.dataModels = {
    character: models.ParanoiaCharacter,
    npc: models.ParanoiaNPC
  }
  CONFIG.Item.documentClass = ParanoiaItem;
  CONFIG.Item.dataModels = {
    item: models.ParanoiaItem,
    feature: models.ParanoiaFeature,
    spell: models.ParanoiaSpell
  }
  ...
  Actors.registerSheet('paranoia', ParanoiaActorSheet, {
    makeDefault: true,
    label: 'PARANOIA.SheetLabels.Actor',
  });
  Items.unregisterSheet('core', ItemSheet);
  Items.registerSheet('paranoia', ParanoiaItemSheet, {
    makeDefault: true,
    label: 'PARANOIA.SheetLabels.Item',
  });
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.paranoia.rollItemMacro("${data.uuid}");`;
